...
public class Word {
    ...
    private static String [] stopWordList = {"a","about","above","across","after","afterwards","again","against","all",
            ...
            "but","by","call","can","cannot","cant","co","computer","con","could","couldnt","cry","de",
...
//    public int getIdf(int numberOfTweet) {
